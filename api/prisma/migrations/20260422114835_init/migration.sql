...
-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('MIC', 'CAMERA', 'CHAT', 'BLUR', 'FOCUS', 'JOIN', 'LEAVE', 'MOUSE_TRACK', 'KEYSTROKE', 'SCREEN_SHARE');
...
-- CreateIndex
CREATE INDEX "Session_courseId_startedAt_idx" ON "Session"("courseId", "startedAt");
