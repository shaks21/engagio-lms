...
var TenantGuard = function () {
    ...
    var TenantGuard = _classThis = /** @class */ (function () {
        function TenantGuard_1(prisma) {
            this.prisma = prisma;
        }
        TenantGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, user, tenant, requestedTenantId;
                var _a, _b, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            requestedTenantId = ((_a = request.params) === null || _a === void 0 ? void 0 : _a.tenantId) ||
                                ((_b = request.body) === null || _b === void 0 ? void 0 : _b.tenantId) ||
                                ((_c = request.query) === null || _c === void 0 ? void 0 : _c.tenantId);
                            if (requestedTenantId &&
                                requestedTenantId !== user.tenantId) {
                                throw new common_1.ForbiddenException("Access denied to tenant resources");
                            }
