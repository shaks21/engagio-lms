    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, tenant, hashedPassword, user, tokens;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            tenant = _a.sent();
                            _a.label = 4;
                        case 4: return [4 /*yield*/, bcrypt.hash(dto.password, 10)];
                        case 5:
                        ...
                        case 6:
                            user = _a.sent();
                            return [4 /*yield*/, this.generateTokens(user.id, user.email, user.role, user.tenantId)];
                        case 7:
                            tokens = _a.sent();
        ...
        AuthService_1.prototype.generateTokens = function (userId, email, role, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var accessToken, refreshToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.jwt.signAsync({ sub: userId, email: email, role: role, tenantId: tenantId }, {
                                secret: this.config.get("JWT_SECRET"),
                                expiresIn: this.config.get("JWT_ACCESS_EXPIRES_IN", "15m"),
                            })];
                        case 1:
                            accessToken = _a.sent();
                            return [4 /*yield*/, this.jwt.signAsync({ sub: userId }, {
