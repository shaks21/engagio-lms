...
- Name: hardware_integrity.spec.ts >> Hardware Integrity Tests >> 4. Video element properly configured - video element exists when camera enabled
- Location: e2e/hardware_integrity.spec.ts:149:7
